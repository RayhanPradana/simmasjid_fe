              ...
              <div className="container mx-auto px-4 text-center z-10">
                ...
                >
                  ...
                  <p className="text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto mb-12">
                    Aplikasi untuk Pusat ibadah dan kegiatan Islami untuk
                    seluruh umat. Mari bergabung dalam perjalanan spiritual
                    bersama komunitas yang hangat dan ramah.
                  </p>
                ...
                <div className="grid md:grid-cols-2 gap-12 items-center">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 mb-6">
                      ...
                      Republik Indonesia, khususnya Laskar Sabilillah yang
                      dipimpin oleh KH. Masjkur. Dibangun pada 8 Agustus 1974,
                      masjid ini menjadi simbol ketaqwaan dan perjuangan dalam
                      membela agama, bangsa, dan tanah air.
                    </p>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-500">
                            Jl. A. Yani No.15, Blimbing, Kec. Blimbing, Kota
              ...
              <div className="container mx-auto px-4 z-10 relative">
                <div className="text-center mb-16">
                  ...
                  <p className="text-gray-600 max-w-2xl mx-auto">
                    Kami menyelenggarakan berbagai kegiatan rutin untuk
                    meningkatkan keimanan dan memperkuat silaturahmi antar
                    jamaah.
                  </p>
                </div>
            ...
            <section id="reservation" className="relative py-24">
              <div className="container mx-auto px-4">
                <div className="text-center mb-16">
                  ...
                  <div className="w-24 h-1 bg-green-600 mx-auto mb-4"></div>
                  <p className="text-gray-600 max-w-2xl mx-auto">
                    SIMASJID menyediakan berbagai fasilitas yang dapat digunakan
                    untuk kegiatan keagamaan, pendidikan, dan sosial.
                  </p>
                </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 mt-8">
                    <div className="flex flex-col items-center">
                      ...
                      <p className="text-gray-600 text-sm">
                        Tentukan fasilitas yang ingin Anda gunakan sesuai
                        kebutuhan
                      </p>
                    </div>
                    ...
                    <div className="flex flex-col items-center">
                      ...
                      <p className="text-gray-600 text-sm">
                        Tunggu konfirmasi dari pengurus masjid melalui email
                        atau telepon
                      </p>
                    </div>
                  </div>
