      ...
      <section id="about" className="relative py-24 bg-white/100">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-green-800 mb-2">Tentang SIMASJID</h2>
      ...
      <section id="schedule" className="relative py-24 bg-green-50">
        ...
        <div className="container mx-auto px-4 z-10 relative">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 transform transition hover:scale-105 hover:shadow-xl">
              <div className="flex items-center justify-between mb-6">
                <h3 className="text-2xl font-bold text-green-700">Kegiatan Rutin</h3>
                <div className="bg-green-100 text-green-600 p-2 rounded-lg">
                  <Calendar size={24} />
                </div>
              </div>
              ...
              <div className="space-y-4">
                {[
                  { name: "Kajian Ba'da Subuh", day: "Setiap Hari", time: "05:15" },
                  { name: "Tahsin Al-Qur'an", day: "Senin & Rabu", time: "16:00" },
                  ...
                  <div key={index} className="p-3 bg-green-50 rounded-lg hover:bg-green-100 transition-colors">
                    <div className="font-medium text-green-700">{activity.name}</div>
                    <div className="flex justify-between mt-1">
                      <span className="text-sm text-gray-500">{activity.day}</span>
                      <span className="text-sm text-green-600">{activity.time}</span>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div>
              ...
              <div className="flex gap-3">
                ...
                <div className="flex flex-col md:flex-row justify-between items-center">
                    ...
                    <a href="#" className="text-sm text-gray-1000 hover:text-green-600 transition-colors">Syarat & Ketentuan</a>
                    <a href="#" className="text-sm text-gray-500 hover:text-green-600 transition-colors">Kebijakan Privasi</a>
                    <a href="#" className="text-sm text-gray-500 hover:text-green-600 transition-colors">Peta Situs</a>
                    </div>
                </div>
            </div>
        </div>
