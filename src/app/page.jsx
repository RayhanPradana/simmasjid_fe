    ...
    <AnimatePresence>
      ...
      >
        ...
        >
          ...
          <p>
            <strong>Nama:</strong> {kegiatan.nama_kegiatan}
          </p>
          <p>
            <strong>Tanggal:</strong> {kegiatan.tanggal}
          </p>
          <p>
            <strong>Jam:</strong> {kegiatan.waktu}
          </p>
          <p>
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-b from-green-50 to-white">
      ...
      >
        ...
        <motion.div
          className="absolute inset-0 bg-[url('/img/sabilillah.jpg')] bg-center bg-no-repeat bg-cover"
          style={{
            opacity: 0.15,
        ...
        <div className="absolute inset-0 bg-[url('/img/islamic-pattern.png')] bg-repeat opacity-5" />
        ...
        <div className="container mx-auto px-4 text-center z-10">
          ...
          >
            ...
            <motion.div
              ...
              className="mb-6"
            >
              <h2 className="text-3xl font-arabic text-green-600 mb-2">
                بِسْمِ اللَّهِ الرَّحْمَنِ الرَّحِيمِ
              </h2>
              <p className="text-lg text-green-700">Bismillahirrahmanirrahim</p>
            </motion.div>
            ...
            <div className="relative">
              ...
              >
                <h1 className="text-4xl sm:text-5xl md:text-7xl font-bold text-green-800 mb-6 relative">
                  Selamat Datang di <br />
                  <span className="text-green-600 relative">
                    SIMASJID
                    <svg
                      className="absolute -right-8 -top-8 w-16 h-16 text-green-500/20"
                      viewBox="0 0 24 24"
                      fill="currentColor"
                    >
            ...
            {/* Description with Islamic Border */}
            <motion.div
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              transition={{ delay: 0.5, duration: 0.8 }}
              className="relative max-w-3xl mx-auto mb-12 p-6"
            >
              <div
                className="absolute inset-0 border-2 border-green-600/20 rounded-lg"
                style={{
                  clipPath:
      ...
      <section id="about" className="relative py-24 -mt-20">
        {/* Top Wave Divider */}
        ...
        <div className="container mx-auto px-4 z-20 relative">
          {/* Decorative Elements */}
          <div className="absolute -top-10 -left-10 w-40 h-40 bg-green-100 rounded-full opacity-20 blur-2xl"></div>
          <div className="absolute top-1/2 right-0 w-60 h-60 bg-green-200 rounded-full opacity-10 blur-3xl"></div>

          {/* Content */}
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="perspective-1000">
              <div
                className="relative h-[600px] rounded-2xl overflow-hidden shadow-2xl transform hover:scale-105 transition-all duration-500"
      ...
      <section
        id="schedule"
        className="relative py-24 bg-gradient-to-b from-white to-green-50/30 overflow-hidden"
      >
        {/* Decorative shapes */}
        <div className="absolute inset-0 opacity-10">
          <div className="absolute top-10 left-10 w-72 h-72 bg-green-200 rounded-full mix-blend-multiply filter blur-xl animate-blob"></div>
          <div className="absolute top-10 right-10 w-72 h-72 bg-green-300 rounded-full mix-blend-multiply filter blur-xl animate-blob animation-delay-2000"></div>
          <div className="absolute bottom-10 left-20 w-72 h-72 bg-green-100 rounded-full mix-blend-multiply filter blur-xl animate-blob animation-delay-4000"></div>
        </div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            <div className="bg-white/80 backdrop-blur-sm rounded-xl shadow-lg p-6 md:col-span-1 hover:shadow-2xl transition-all duration-300 border border-green-100/50">
              ...
              <div className="space-y-4 max-h-[400px] overflow-y-auto scrollbar-thin scrollbar-thumb-green-200 scrollbar-track-transparent">
      ...
      {/* Reservation Section - Add slanted dividers */}
      <section id="reservation" className="relative py-24">
        {/* Top Slant Divider */}
        <div
          className="absolute top-0 left-0 right-0 h-20 bg-green-50"
          style={{
            ...
            <div className="grid grid-cols-1 sm:grid-cols-7 gap-8 mt-8">
              {[
                ...
                <div key={index} className="flex flex-col items-center">
                  ...
                  <h4
                    className={`font-semibold mb-2 transition-colors duration-100 ease-in-out
                    ${
                      currentStep === index + 1
                        ? "text-green-700"
                        : "text-gray-600"
        ...
        <div
          className="absolute bottom-0 left-0 right-0 h-20 bg-green-50"
          style={{
      ...
      {/* News Section - Add wave dividers */}
      <section
        id="news"
        className="relative py-24 bg-gradient-to-b from-green-50/30 to-white overflow-hidden"
      >
                ...
                .map((news, index) => (
                  ...
                  >
                    ...
                    <div className="h-48 overflow-hidden">
                      <img
                        src={`${apiUrl}/storage/${news.gambar}`}
                        alt={news.judul}
                        className="w-full h-full object-cover"
                      />
                    </div>
                    <div className="p-6">
                      ...
                      <p className="text-gray-600 text-sm mb-4">
                        {news.konten.length > 100
                          ? news.konten.slice(0, 100) + "..."
                          : news.konten}
                      </p>
