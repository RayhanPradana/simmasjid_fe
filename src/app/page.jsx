      ...
      <section id="news" className="relative py-24 bg-green-50/70">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
            {data1.filter((news) => news.status === "Publikasi").length ===
            0 ? (
                ...
                .map((news, index) => (
                  ...
                  >
                    <div className="h-48 overflow-hidden">
                      <img
                        src={`http://localhost:8000/storage/${news.gambar}`} // Pastikan path-nya benar, misal: http://127.0.0.1:8000/storage/img/...
                        alt={news.judul}
                        className="w-full h-full object-cover"
                      />
                    </div>
                    ...
                    <div className="p-6">
                      <div className="text-xs text-green-600 font-medium mb-2 flex items-center gap-1">
                        ...
                        {news.tanggal}{" "}
                        {/* Ganti sesuai nama field tanggal pada database */}
                      </div>
